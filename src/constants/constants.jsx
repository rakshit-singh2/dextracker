...
export const chains = ['avalanche','bnb','Cronos','Ethereum','Fantom','Polygon','DFK Subnet','SmartBCH','Celo','Klaytn','Aurora','HECO','XDAI','Harmony','Boba','OKEX','Moonriver','Canto','BitTorrent Chain','Oasis','Velas','Arbitrum','Optimistic','Kucoin','BitTorrent Chain','Moonbeam','Base','Shibarium','Mantle','ZkSync','Linea','Metis','Manta','Polygon zkEVM','Scroll','Arbitrum Nova','Shimmer EVM','Vanar Vanguard Testnet','Oasis Saphire','Zetachain','Hedera','Zora','Astar','Blast','Wemix','Sui','Solana','Starknet','Secret Network','Alephium','Celestia','Arthera','Arthera Testnet','GraphLinq','Degen','ZkLink Nova','Bahamut']

export const chainsLogo = ["/img/tokenlogo/avalanche.png", "/img/tokenlogo/bnb.png", "/img/tokenlogo/cronos.png", "/img/tokenlogo/ethereum.png", "/img/tokenlogo/fantom.png", "/img/tokenlogo/polygon.png", "/img/tokenlogo/dfksubnet.png", "/img/tokenlogo/smartbch.png", "/img/tokenlogo/celo.png", "/img/tokenlogo/klaytn.png", "/img/tokenlogo/aurora.png", "/img/tokenlogo/heco.png", "/img/tokenlogo/xdai.png", "/img/tokenlogo/harmony.png", "/img/tokenlogo/boba.png", "/img/tokenlogo/okex.png", "/img/tokenlogo/moonriver.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", 
"/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png", "/img/tokenlogo/dummyimage.png",]
