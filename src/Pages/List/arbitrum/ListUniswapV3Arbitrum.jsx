...
import TokenRowUniswapV3Arbitrum from "../../../Components/TokenRow/arbitrum/TokenRowUniswapV3Arbitrum";

const ListUniswapV3Arbitrum = () => {
  const GET_POOLS = gql`
                ...
                <tbody>
                  {
                    data && data.pools && data.pools.length > 0 ? (
                      data.pools.map((pool, index) => (
                        <TokenRowUniswapV3Arbitrum key={index} pool={pool} />
                      ))
                    ) : (
                      <tr>
...
export default ListUniswapV3Arbitrum;