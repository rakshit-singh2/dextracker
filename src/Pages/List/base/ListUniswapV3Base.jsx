...
import TokenRowUniswapV3Base from "../../../Components/TokenRow/base/TokenRowUniswapV3Base";

const ListUniswapV3Base = () => {
  const GET_POOLS = gql`
                ...
                <tbody>
                  {
                    data && data.pools && data.pools.length > 0 ? (
                      data.pools.map((pool, index) => (
                        <TokenRowUniswapV3Base key={index} pool={pool} />
                      ))
                    ) : (
                      <tr>
...
export default ListUniswapV3Base;