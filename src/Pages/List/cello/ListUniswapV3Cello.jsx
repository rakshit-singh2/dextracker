...
import TokenRowUniswapV3Cello from "../../../Components/TokenRow/cello/TokenRowUniswapV3Cello";

const ListUniswapV3Cello = () => {
  const GET_POOLS = gql`
                ...
                <tbody>
                  {
                    data && data.pools && data.pools.length > 0 ? (
                      data.pools.map((pool, index) => (
                        <TokenRowUniswapV3Cello key={index} pool={pool} />
                      ))
                    ) : (
                      <tr>
...
export default ListUniswapV3Cello;