...
import TokenRowUniswapV3Bsc from "../../../Components/TokenRow/bsc/TokenRowUniswapV3Bsc";
import Header from "../../../Components/Header/Header";

const ListUniswapV3Bsc = () => {
  const GET_POOLS = gql`
                  ...
                  <tbody>
                    {
                      data && data.pools && data.pools.length > 0 ? (
                        data.pools.map((pool, index) => (
                          <TokenRowUniswapV3Bsc key={index} pool={pool} />
                        ))
                      ) : (
                        <tr>
...
export default ListUniswapV3Bsc;