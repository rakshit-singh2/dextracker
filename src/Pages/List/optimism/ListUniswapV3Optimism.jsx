...
import TokenRowUniswapV3Optimism from "../../../Components/TokenRow/optimism/TokenRowUniswapV3Optimism";
import Header from "../../../Components/Header/Header";
const ListUniswapV3Optimism = () => {
  const GET_POOLS = gql`
                  ...
                  <tbody>
                    {
                      data && data.pools && data.pools.length > 0 ? (
                        data.pools.map((pool, index) => (
                          <TokenRowUniswapV3Optimism key={index} pool={pool} />
                        ))
                      ) : (
                        <tr>
...
export default ListUniswapV3Optimism;