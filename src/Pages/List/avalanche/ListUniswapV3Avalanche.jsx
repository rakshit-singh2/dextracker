...
import TokenRowUniswapV3Avalanche from "../../../Components/TokenRow/avalanche/TokenRowUniswapV3Avalanche";

const ListUniswapV3Avalanche = () => {
  const GET_POOLS = gql`
                ...
                <tbody>
                  {
                    data && data.pools && data.pools.length > 0 ? (
                      data.pools.map((pool, index) => (
                        <TokenRowUniswapV3Avalanche key={index} pool={pool} />
                      ))
                    ) : (
                      <tr>
...
export default ListUniswapV3Avalanche;